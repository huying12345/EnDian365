...
namespace Yamon.Module.PortalIPS.Web.Controllers
{
    ...
    public partial class _CategoryTypeController :BaseController
    {
        ...
        public ActionResult Index(string m,string filterId)
        {
            ...
            ViewBag.DAL = new CategoryTypeDAL();
            ...
            string formPath = string.Format("~/Areas/PortalIPS/Views/CategoryType/_/{0}.cshtml", m);
...
public virtual ActionResult Create(string id = "")
{
    ViewBag.ID = id;
    ViewBag.DAL=dal;
    CategoryType model= dal.GetCreateFormDefaultValue();
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/PortalIPS/Views/CategoryType/_/Create.cshtml");
...
public virtual ActionResult Edit(string id = "")
{
    ...
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/PortalIPS/Views/CategoryType/_/Edit.cshtml");
    return View(formPath,model);
}public virtual ActionResult Show(string id = "")
{
    ...
    CategoryType model = dal.GetModelByID(id);
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/PortalIPS/Views/CategoryType/_/Show.cshtml");
    return View(formPath,model);
}
