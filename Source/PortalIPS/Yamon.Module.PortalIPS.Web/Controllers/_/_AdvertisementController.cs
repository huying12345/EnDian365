...
namespace Yamon.Module.PortalIPS.Web.Controllers
{
    ...
    public partial class _AdvertisementController :BaseController
    {
        ...
        public ActionResult Index(string m,string filterId)
        {
            ...
            ViewBag.DAL = new AdvertisementDAL();
            ...
            string formPath = string.Format("~/Areas/PortalIPS/Views/Advertisement/_/{0}.cshtml", m);
...
public virtual ActionResult Create(string id = "")
{
    ViewBag.ID = id;
    ViewBag.DAL=dal;
    Advertisement model= dal.GetCreateFormDefaultValue();
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/PortalIPS/Views/Advertisement/_/Create.cshtml");
...
public virtual ActionResult Edit(string id = "")
{
    ...
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/PortalIPS/Views/Advertisement/_/Edit.cshtml");
    return View(formPath,model);
}public virtual ActionResult Show(string id = "")
{
    ...
    Advertisement model = dal.GetModelByID(id);
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/PortalIPS/Views/Advertisement/_/Show.cshtml");
    return View(formPath,model);
}
