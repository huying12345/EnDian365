...
namespace Yamon.Module.PortalIPS.WebApi
{
    ...
    public partial class _CategoryController :BaseController
    {
        ...
        [ValidateInput(false)]
        [LogFilter]
        public virtual ActionResult Create(Category model,bool returnData=false)
        {
            object newId = "";
            try
            {
                ...
                if (result > 0)
                {
                            newId = model.CategoryID;

                    hash["id"] = newId;
                    if(returnData){
                        Category newrow = dal.GetModelByID(newId);
                        hash["data"] = newrow;
                    }
                }
        ...
        [LogFilter]
        public virtual ActionResult Edit(Category model,bool returnData=false)
        {
            try
            {
               ...
               if (result > 0)
                {
                    hash["id"] = model.CategoryID;
                    if(returnData){
                        Category newrow = dal.GetModelByID(model.CategoryID);
                        hash["data"] = newrow;
                    }
                }
            }
        ...
        [NonAction]        
        public  virtual List<Category> GetGridList(string filterId, int showValue, out int totalRows)
        {
            totalRows = 0;
            ...
            switch(filterId)
            {
                    case "Category_AppID":
                    {
                      modelList = dal.GetEntityListByPage_AppID(out totalRows,0,page,rows,orderby);
                      break;
                    }
        ...
        {
            filterId = string.IsNullOrEmpty(filterId)?"Category_AppID":filterId;
            try
            {
                int totalRows = 0;
		...
		public  virtual ActionResult TreeGridByFilterID(string filterId)
        {
            ...
            try
            {
                ...
                switch(filterId)
                {
                        case "Category_AppID":
                        {
                          modelList = dal.GetEntityListByPage_AppID(out _totalRows,0,page,rows);
                          break;
                        }
               ...
               List<Category> newModelList = modelList.Select(model => dal.GetModelGridShowValue(model)).ToList();
        ...
        public  virtual ActionResult TreeJsonByFilterID(string filterId)
        {
            ...
            try
            {
                ...
                string fields="CategoryID,CategoryName,C_ParentID,OrderNum";
                ...
                switch(filterId)
                {
                        case "Category_AppID":
                        {
                          table = dal.GetAllEntityTable_AppID(fields);
                          break;
                        }
                ...
                TreeHelper treeHelper = new TreeHelper("CategoryID", "CategoryName", "OrderNum", "C_ParentID");
		...
		public  virtual ActionResult AsyncTreeGridByFilterID(string filterId)
        {
            ...
            try
            {
                ...
                switch(filterId)
                {
					case "Category_AppID":
					{
					  modelList = dal.GetAsyncModelTreeList_AppID(parentId);
					  break;
					}
        ...
        public  virtual ActionResult AsyncTreeJsonByFilterID(string filterId)
        {
            ...
            try
            {
                ...
                switch(filterId)
                {
                        case "Category_AppID":
                        {
                          table = dal.GetAsyncTreeList_AppID(parentId,"CategoryID,CategoryName");
                          break;
                        }

                     default:
                     {
                        table = dal.GetAsyncTreeList(parentId,"CategoryID,CategoryName");
                        break;
                     }
                }
                TreeHelper treeHelper = new TreeHelper("CategoryID", "CategoryName", "OrderNum", "C_ParentID");
        ...
        {
            int result = dal.UpdateSingleFieldValue("CategoryName", value,id );
            hash["success"] = result > 0;
            return Json(hash);
        }   
    [LogFilter]
    ...
    public virtual ActionResult Delete(string id)
    {
        ...
        [CheckPurview(pageCode:"PortalIPS_Category_Show")]        
